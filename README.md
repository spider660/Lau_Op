...
### INSTALL SCRIPT 
```
 wget -q https://raw.githubusercontent.com/spider660/Lau_Op/heads/main/install && chmod +x install  && ./install 

```

### UPDATED SCRIPT
```
rm -f update.sh && wget -O update.sh https://github.com/spider660/Lau_Op/raw/refs/heads/main/menu/update.sh && chmod +x update.sh && ./update.sh
